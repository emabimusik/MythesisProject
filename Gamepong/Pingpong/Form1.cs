...
namespace Pingpong
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Boolean Collision_Enemy(PictureBox tar)
        {
                    ...
                    temp1.SetBounds(temp1.Location.X, temp1.Location.Y + 25, 1, 10);
                    ...
                    temp1.SetBounds(temp1.Location.X, temp1.Location.Y + 50, 1, 10);
            ...
            if (GameOn)         // All movement only happens with game is on
            {
               // pb_stimuli.Visible = true;
                ...
                {               // If Player should to up, and doesnt collide with the top
                    ...
                    pb_stimuli.Location = new Point(130, 30);
                }
                ...
                {               // Same here but going down instead, collision at the bottom check
                    ...
                    pb_stimuli.Location = new Point(50, 1200);
                }
                ...
                if (BallGoingLeft)  //If the ball is going left
                {
                    if (Collision_Left(pb_Ball))    //If the ball collides with the left side wall
                    {
                        ...
                        pb_Ball.Location = new Point(1700, rng.Next(10, 1400));
       ...
       */
        ...
        {
            // make the pb_stimuli round
            //CircleThis(pb_stimuli);
          ...
          */
            ...
            pb_Ball.Location = new Point(1700, rng.Next(10, 1400));   // Moves the ball in place
        ...
        public void AddScore(PictureBox[] Arr)
        {
            ...
            {   //If they all are black, game ends.
                ...
                RestoreScore();
                pb_Ball.Location = new Point(1700, rng.Next(10, 1400));
                pb_Player.Location = new Point(3, 345);
                pb_Enemy.Location = new Point(3400, 345);
                Round = 0;
        ...
        private void WorldFrame_Click(object sender, EventArgs e)
        {
